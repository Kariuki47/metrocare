                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <CardAside title="ECG"
                                :description="`ECG information on ` + $page.props.appName + `.`"
                                :patient="props.patient">

                                <div class="nk-block-content">
                                    <form
                                        @submit.prevent="form.post(route('ecg.update', props.ecg.id), { preserveScroll: true })">
                                        <div class="gy-3 row">
                                            <div class="col-12">
                                                <FormField label="ECG" wrap-body>
                                                    <FormCheckRadioGroupNew v-model="form.ecg" type="radio"
                                                        name="ecg" :options="ecg_option" />
                                                </FormField>
                                            </div>
                                            <div class="col-12">
