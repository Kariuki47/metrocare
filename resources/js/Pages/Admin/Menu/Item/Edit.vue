...
const form = useForm({
  ...
  parent_id: props.item.parent_id ? props.item.parent_id:'',
          ...
          <div class="components-preview wide-md mx-auto">
            <div class="nk-block-head nk-block-head-lg wide-sm">
              <div class="nk-block-head-content">
                ...
                <h2 class="nk-block-title fw-normal">Update menu item</h2>
              </div>
            </div>
            <div class="nk-block nk-block-lg">
              <div class="card card-bordered">
                <div class="card-inner">
                  <form @submit.prevent="form.post(route('menu.item.update', { menu: props.menu.id, item: props.item.id }))">
                    <div class="row g-4">
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        <FormField label="Icon" :class="{ 'text-red-400': form.errors.icon }" label-for="icon">
                          <FormControl v-model="form.icon" type="text" placeholder="Enter Icon" id="icon"
