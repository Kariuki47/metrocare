    ...
    <GuestLayout>
        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">Two-factor Confirmation</h5>
            ...
            <div v-else class="form-group">
                ...
                <div class="form-control-wrap">
                    <TextInput id="recovery_code" ref="recoveryCodeInput" v-model="form.recovery_code" type="text"
                        class="form-control form-control-lg" autocomplete="one-time-code" />
                </div>
                <InputError class="mt-2" :message="form.errors.recovery_code" />
            </div>

            <div class="flex items-center justify-start mt-4">
                <PrimaryButton class="btn btn-primary" :class="{ 'opacity-5': form.processing }"
                ...
                <button type="button" class="form-note-s2 ml-4" @click.prevent="toggleRecovery">
                    <template v-if="!recovery">
                        Use a recovery code
                    </template>
